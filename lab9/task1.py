...
background = pygame.image.load("C:/Users/Alinur/Documents/pp2/lab9/Street.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Alinur/Documents/pp2/lab9/Enemy (1).png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Alinur/Documents/pp2/lab9/Player (1).png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Alinur/Documents/pp2/lab9/coin.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, SCREEN_WIDTH - 40), 0)
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound('C:/Users/Alinur/Documents/pp2/lab9/crash.wav').play()
        time.sleep(0.5)
